...
export default function Laporan(props) {
    ...
    const exportToPDF = () => {
        ...
        // Info line
        const guruNama = gurus.find(g => g.id == filters.guru_id)?.nama ?? '-';
        const kelasNama = classes.find(c => c.id == filters.kelas_id)?.nama ?? '-';
        const infoText = `Penguji: ${guruNama} | Kelas: ${kelasNama} | Bulan: ${bulanLabel} ${filters.tahun}`;
        doc.setFontSize(10);
        ...
        autoTable(doc, {
            startY: 35,
            head: [['NO', 'NAMA SANTRI', 'NIS', 'KELAS', 'BL', 'BS', 'JN']],
        ...
        doc.text(
            'Catatan: BL = jumlah juz pada bulan sebelumnya, BS = jumlah juz pada bulan terpilih, JN = peningkatan juz (BS - BL).',
            14,
            finalY + 10
        );
        ...
        doc.text('BL: Bulan Lalu | BS: Bulan Sekarang | JN: Juz Nambah', 14, finalY + 23);
                                ...
                                <table className="w-full border border-gray-300 text-xs">
                                    <thead>
                                        <tr className="bg-green-500 text-white">
                                            ...
                                            <th className="w-12 border border-gray-300 py-2">JN</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {results.length === 0 && (
