...
const SantriEdit = ({ santri }) => {
    const { data, setData, post, errors } = useForm({
        ...
        ayah_status: santri.ayah_status || '',
        ayah_status_hubungan: santri.ayah_status_hubungan || '',
        ayah_tempat_lahir: santri.ayah_tempat_lahir || '',
        ayah_tanggal_lahir: santri.ayah_tanggal_lahir || '',
        ayah_pendidikan: santri.ayah_pendidikan || '',
        ayah_pekerjaan: santri.ayah_pekerjaan || '',
        ayah_penghasilan: santri.ayah_penghasilan || '',
        ayah_email: santri.ayah_email || '',
        ayah_handphone: santri.ayah_handphone || '',
        ayah_alamat: santri.ayah_alamat || '',

        // Orang Tua Ibu
        ibu_nama: santri.ibu_nama || '',
        ibu_status: santri.ibu_status || '',
        ibu_status_hubungan: santri.ibu_status_hubungan || '',
        ibu_tempat_lahir: santri.ibu_tempat_lahir || '',
        ibu_tanggal_lahir: santri.ibu_tanggal_lahir || '',
        ibu_pendidikan: santri.ibu_pendidikan || '',
        ibu_pekerjaan: santri.ibu_pekerjaan || '',
        ibu_penghasilan: santri.ibu_penghasilan || '',
        ibu_email: santri.ibu_email || '',
        ibu_handphone: santri.ibu_handphone || '',
        ibu_alamat: santri.ibu_alamat || '',

        // Wali (opsional)
        wali_nama: santri.wali_nama || '',
        wali_status: santri.wali_status || '',
        wali_status_hubungan: santri.wali_status_hubungan || '',
        wali_tempat_lahir: santri.wali_tempat_lahir || '',
        wali_tanggal_lahir: santri.wali_tanggal_lahir || '',
        wali_pendidikan: santri.wali_pendidikan || '',
        wali_pekerjaan: santri.wali_pekerjaan || '',
        wali_penghasilan: santri.wali_penghasilan || '',
        wali_email: santri.wali_email || '',
        wali_handphone: santri.wali_handphone || '',
        wali_alamat: santri.wali_alamat || '',
