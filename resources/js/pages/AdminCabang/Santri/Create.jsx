            ...
            <div className="space-y-4">
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                    <form onSubmit={onSubmit}>
                        ...
                        {/* Orang Tua */}
                        <div className="mt-8">
                            <h3 className="text-md mb-2 font-semibold">Data Orang Tua/Wali</h3>
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                ...
                                <div className="rounded-lg border bg-gray-50 p-4">
                                    ...
                                    <FormInput
                                        ...
                                        name="ayah_status_hubungan"
                                        type="select"
                                        value={data.ayah_status_hubungan}
                                        onChange={onChange}
                                        options={statusHubungan}
                                        required
                                    />
                                ...
                                <div className="rounded-lg border bg-gray-50 p-4">
                                    ...
                                    <FormInput
                                        label="Status Hubungan"
                                        name="ibu_status_hubungan"
                                        type="select"
                                        value={data.ibu_status_hubungan}
                                        onChange={onChange}
                                        options={statusHubungan}
                                        required
                                    />
                                ...
                                {/* Wali */}
                                <div className="rounded-lg border bg-gray-50 p-4">
                                    <h4 className="mb-2 font-semibold">Wali (Opsional)</h4>
                                    <FormInput label="Nama" name="wali_nama" value={data.wali_nama} onChange={onChange} />
                                    <FormInput
                                        label="Status"
                                        name="wali_status"
                                        type="select"
                                        value={data.wali_status}
                                        onChange={onChange}
                                        options={statusOrtu}
                                    />
                                    <FormInput
                                        label="Status Hubungan"
                                        name="wali_status_hubungan"
                                        type="select"
                                        value={data.wali_status_hubungan}
                                        onChange={onChange}
                                        options={statusHubungan}
                                    />
                        ...
                        {/* Kesehatan */}
                        <div className="mt-8">
                            <h3 className="text-md mb-2 font-semibold">Data Kesehatan Santri</h3>
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <FormInput
