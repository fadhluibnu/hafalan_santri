...
const ustadzCreate = () => {
    ...
    const onSubmit = (e) => {
        ...
        post(route('admin-cabang.ustadz.store'), {
            onSuccess: () => {
                setLoading(false);
            },
            onError: () => {
        ...
        <Layout title="Tambah ustadz">
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <h2 className="text-lg font-semibold text-gray-700">Form Tambah ustadz</h2>
                    <Link
