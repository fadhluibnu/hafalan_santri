        ...
        <Layout title={`Edit Guru - ${data.nama}`}>
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    {errors.error && <div className="mb-4 rounded bg-red-100 p-4 text-red-700">{errors.error}</div>}
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                <h3 className="text-md mb-2 border-b pb-2 font-semibold text-gray-700">Data Pribadi</h3>
                            </div>
                            <FormInput label="NIP" name="nip" value={data.nip} onChange={onChange} required error={errors.nip} />
                            <FormInput label="Nama Lengkap" name="nama" value={data.nama} onChange={onChange} required error={errors.nama} />
                            <FormInput label="Gelar Awal" name="gelar_awal" value={data.gelar_awal} onChange={onChange} error={errors.gelar_awal} />
                            <FormInput
                                label="Gelar Akhir"
                                name="gelar_akhir"
                            ...
                            <div className="mt-8 flex items-center">
                                ...
                                {errors.status_menikah && <p className="mt-1 text-sm text-red-600">{errors.status_menikah}</p>}
                            </div>
                            <div className="md:col-span-2">
                                <FormInput
                                    label="Alamat"
                            ...
                            {/* Data Kontak */}
                            <div className="md:col-span-2">
                                <h3 className="text-md mt-4 mb-2 border-b pb-2 font-semibold text-gray-700">Data Kontak</h3>
                            </div>
                            <FormInput
                                label="No Identitas"
                                name="no_identitas"
                            ...
                            {/* Data Akun */}
                            <div className="md:col-span-2">
                                <h3 className="text-md mt-4 mb-2 border-b pb-2 font-semibold text-gray-700">Data Akun</h3>
                            </div>
                            <FormInput label="Username" name="username" value={data.username} onChange={onChange} required error={errors.username} />
                            <FormInput label="Email" name="email" type="email" value={data.email} onChange={onChange} required error={errors.email} />
                            <FormInput
                            ...
                            {/* Data Pekerjaan */}
                            <div className="md:col-span-2">
                                <h3 className="text-md mt-4 mb-2 border-b pb-2 font-semibold text-gray-700">Data Pekerjaan</h3>
                            </div>
                            <FormInput
                            ...
                            <div className="mt-8 flex items-center">
                                ...
                                {errors.non_aktif && <p className="mt-1 text-sm text-red-600">{errors.non_aktif}</p>}
                            </div>
                            <div className="md:col-span-2">
                                <FormInput
                                    label="Keterangan"
                        ...
                        <div className="mt-6 flex items-center justify-end space-x-3 border-t pt-6">
                            ...
                            <button
                                ...
                                className={`rounded-md bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-green-700 ${
                                    processing || loading ? 'cursor-not-allowed opacity-50' : ''
                                }`}
                            >
